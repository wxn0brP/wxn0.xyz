...
export const achievements: Achievement[] = [
	...
	},
	{
		...
		name: "Brave Soul",
		description:
			"Enter vim (congratulations on your courage or your stupidity).",
		xp: 25,
		requiredLevel: 3,
	},
	{
	...
	},
	{
		...
		hidden: true,
		description:
			"You were never meant to earn this. You found it by reading the source code.",
	},
	{
		id: "completionist",
		name: "Completionist",
...
export function getVisibleAchievements() {
	...
	for (const achievement of achievements) {
		...
		const levelLocked =
			...
			currentLevel < achievement.requiredLevel;
